...
const pinsel_table_t pinsel_func_table[TOTAL_PINS] = {
		...
		{{ ENTRY(CORE_PERIPH_PIO, 0),  ENTRY(CORE_PERIPH_UART, 1),  ENTRY(CORE_PERIPH_SSP, 0),  ENTRY(CORE_PERIPH_SPI, 0) }}, //0.15
		{{ ENTRY(CORE_PERIPH_PIO, 0),  ENTRY(CORE_PERIPH_UART, 1),  ENTRY(CORE_PERIPH_SSP, 0),  ENTRY(CORE_PERIPH_SPI, 0) }}, //0.16
		{{ ENTRY(CORE_PERIPH_PIO, 0),  ENTRY(CORE_PERIPH_UART, 1),  ENTRY(CORE_PERIPH_SSP, 0),  ENTRY(CORE_PERIPH_SPI, 0) }}, //0.17
		{{ ENTRY(CORE_PERIPH_PIO, 0),  ENTRY(CORE_PERIPH_UART, 1),  ENTRY(CORE_PERIPH_SSP, 0),  ENTRY(CORE_PERIPH_SPI, 0) }}, //0.18
...
const pinsel_table_t pinsel_func_table[TOTAL_PINS] = {
		...
		{{ ENTRY(CORE_PERIPH_PIO, 1), ENTRY(CORE_PERIPH_USB, 1), ENTRY(CORE_PERIPH_PWM, 1), ENTRY(CORE_PERIPH_QEI, 0), ENTRY(CORE_PERIPH_MCPWM, 0), ENTRY(CORE_PERIPH_SSP, 0), ENTRY(CORE_PERIPH_LCD, 0), ENTRY(CORE_PERIPH_LCD, 0) }}, //1.20
